...
def georeferencing(file_name, df, location, crs, input_dir, output_path, sensor, mode, elevation_map_path):
...
def collect_info_specific_path(filepath, output_folder):
