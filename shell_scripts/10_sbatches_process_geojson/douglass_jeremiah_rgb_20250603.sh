...
echo "Running to generating geojson for: douglass_jeremiah_rgb_20250603"
...
python "process_geojson.py" \
    ...
    --date "20250603" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/douglass_jeremiah/20250603/douglass_jeremiah_20250603.geojson"
