...
echo "Running to generating geojson for: frantom_b89_rgb_20250515"
...
python "process_geojson.py" \
    ...
    --date "20250515" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/frantom_b89/20250515/frantom_b89_20250515.geojson"
