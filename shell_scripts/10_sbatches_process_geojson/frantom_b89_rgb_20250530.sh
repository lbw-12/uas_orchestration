...
echo "Running to generating geojson for: frantom_b89_rgb_20250530"
...
python "process_geojson.py" \
    ...
    --date "20250530" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/frantom_b89/20250530/frantom_b89_20250530.geojson"
