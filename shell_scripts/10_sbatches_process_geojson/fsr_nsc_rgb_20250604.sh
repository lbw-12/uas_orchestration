...
echo "Running to generating geojson for: fsr_nsc_rgb_20250604"
...
python "process_geojson.py" \
    ...
    --location "fsr_nsc" \
    --date "20250604" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/fsr_nsc/20250604/fsr_nsc_20250604.geojson"
