...
echo "Running to generating geojson for: fsr_replant_ms_20250604"
...
python "process_geojson.py" \
    ...
    --date "20250604" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/fsr_replant/20250604/fsr_replant_20250604.geojson"
