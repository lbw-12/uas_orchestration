...
echo "Running to generating geojson for: hoelsher_rgb_20250530"
...
python "process_geojson.py" \
    ...
    --location "hoelsher" \
    --date "20250530" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/hoelsher/20250530/hoelsher_20250530.geojson"
