...
echo "Running to generating geojson for: kuntz_springhill_ms_20250526"
...
python "process_geojson.py" \
    ...
    --date "20250526" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/kuntz_springhill/20250526/kuntz_springhill_20250526.geojson"
