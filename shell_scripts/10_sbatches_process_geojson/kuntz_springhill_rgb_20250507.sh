...
echo "Running to generating geojson for: kuntz_springhill_rgb_20250507"
...
python "process_geojson.py" \
    ...
    --date "20250507" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/kuntz_springhill/20250507/kuntz_springhill_20250507.geojson"
