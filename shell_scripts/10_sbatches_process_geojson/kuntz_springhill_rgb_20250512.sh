...
echo "Running to generating geojson for: kuntz_springhill_rgb_20250512"
...
python "process_geojson.py" \
    ...
    --date "20250512" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/kuntz_springhill/20250512/kuntz_springhill_20250512.geojson"
