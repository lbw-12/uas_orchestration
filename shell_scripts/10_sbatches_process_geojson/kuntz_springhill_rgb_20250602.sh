...
echo "Running to generating geojson for: kuntz_springhill_rgb_20250602"
...
python "process_geojson.py" \
    ...
    --date "20250602" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/kuntz_springhill/20250602/kuntz_springhill_20250602.geojson"
