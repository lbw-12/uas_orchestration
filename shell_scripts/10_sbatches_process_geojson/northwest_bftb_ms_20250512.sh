...
echo "Running to generating geojson for: northwest_bftb_ms_20250512"
...
python "process_geojson.py" \
    ...
    --date "20250512" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/northwest_bftb/20250512/northwest_bftb_20250512.geojson"
