...
echo "Running to generating geojson for: northwest_bftb_rgb_20250609"
...
python "process_geojson.py" \
    ...
    --date "20250609" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/northwest_bftb/20250609/northwest_bftb_20250609.geojson"
