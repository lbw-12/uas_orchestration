...
echo "Running to generating geojson for: northwest_n_rgb_20250602"
...
python "process_geojson.py" \
    ...
    --date "20250602" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/northwest_n/20250602/northwest_n_20250602.geojson"
