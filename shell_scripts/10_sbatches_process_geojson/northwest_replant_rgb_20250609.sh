...
echo "Running to generating geojson for: northwest_replant_rgb_20250609"
...
python "process_geojson.py" \
    ...
    --date "20250609" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/northwest_replant/20250609/northwest_replant_20250609.geojson"
