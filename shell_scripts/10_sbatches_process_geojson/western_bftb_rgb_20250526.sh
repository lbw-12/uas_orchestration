...
echo "Running to generating geojson for: western_bftb_rgb_20250526"
...
python "process_geojson.py" \
    ...
    --date "20250526" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/western_bftb/20250526/western_bftb_20250526.geojson"
