...
echo "Running to generating geojson for: western_nsc_ms_20250526"
...
python "process_geojson.py" \
    ...
    --date "20250526" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/western_nsc/20250526/western_nsc_20250526.geojson"
