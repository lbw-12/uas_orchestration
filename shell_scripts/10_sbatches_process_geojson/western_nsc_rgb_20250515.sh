...
echo "Running to generating geojson for: western_nsc_rgb_20250515"
...
python "process_geojson.py" \
    ...
    --date "20250515" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/western_nsc/20250515/western_nsc_20250515.geojson"
