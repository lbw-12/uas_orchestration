...
echo "Running to generating geojson for: western_nsc_rgb_20250519"
...
python "process_geojson.py" \
    ...
    --date "20250519" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/western_nsc/20250519/western_nsc_20250519.geojson"
