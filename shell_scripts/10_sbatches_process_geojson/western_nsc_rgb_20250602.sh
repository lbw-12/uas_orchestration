...
echo "Running to generating geojson for: western_nsc_rgb_20250602"
...
python "process_geojson.py" \
    ...
    --date "20250602" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/western_nsc/20250602/western_nsc_20250602.geojson"
