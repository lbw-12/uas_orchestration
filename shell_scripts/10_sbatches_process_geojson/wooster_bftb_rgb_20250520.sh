...
echo "Running to generating geojson for: wooster_bftb_rgb_20250520"
...
python "process_geojson.py" \
    ...
    --date "20250520" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/wooster_bftb/20250520/wooster_bftb_20250520.geojson"
