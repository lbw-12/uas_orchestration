...
echo "Running to generating geojson for: wooster_replant_rgb_20250508"
...
python "process_geojson.py" \
    ...
    --date "20250508" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/wooster_replant/20250508/wooster_replant_20250508.geojson"
