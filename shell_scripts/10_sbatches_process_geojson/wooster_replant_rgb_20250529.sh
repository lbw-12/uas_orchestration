...
echo "Running to generating geojson for: wooster_replant_rgb_20250529"
...
python "process_geojson.py" \
    ...
    --date "20250529" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/2025/wooster_replant/20250529/wooster_replant_20250529.geojson"
