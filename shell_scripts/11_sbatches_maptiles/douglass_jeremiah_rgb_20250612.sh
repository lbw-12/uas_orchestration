#!/bin/bash
#SBATCH -J "maptile_douglass_jeremiah_rgb_20250612"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-douglass_jeremiah_rgb_20250612-maptiles.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-douglass_jeremiah_rgb_20250612-maptiles.err
#SBATCH --mem=32GB
...
OM_FILENAME="douglass_jeremiah_rgb_20250612_aligned.tif"


echo "Running map tile creation for: douglass_jeremiah_rgb_20250612"
...
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/douglass_private/2025/douglass_jeremiah/20250612"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/douglass_private/2025/douglass_jeremiah/20250612" | awk '{print $1}')
...
maptiles_dir=/fs/ess/PAS2699/nitrogen/data/uas/published/douglass_private/2025/douglass_jeremiah/20250612
