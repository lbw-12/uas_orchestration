#!/bin/bash
#SBATCH -J "maptile_douglass_lincoln_rgb_20250603"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-douglass_lincoln_rgb_20250603-maptiles.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-douglass_lincoln_rgb_20250603-maptiles.err
#SBATCH --mem=32GB
...
job_name="douglass_lincoln_rgb_20250603"

OM_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/"
OM_FILENAME="douglass_lincoln_rgb_20250603_aligned.tif"


echo "Running map tile creation for: douglass_lincoln_rgb_20250603"
...
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/douglass_private/2025/douglass_lincoln/20250603"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/douglass_private/2025/douglass_lincoln/20250603" | awk '{print $1}')
...
maptiles_dir=/fs/ess/PAS2699/nitrogen/data/uas/published/douglass_private/2025/douglass_lincoln/20250603
