#!/bin/bash
#SBATCH -J "maptile_frantom_b89_rgb_20250523"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="frantom_b89_rgb_20250523_aligned.tif"


echo "Running map tile creation for: frantom_b89_rgb_20250523"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89/20250523"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89/20250523"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89/20250523" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89/20250523")
