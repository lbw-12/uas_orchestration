#!/bin/bash
#SBATCH -J "maptile_frantom_b89_rgb_20250530"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="frantom_b89_rgb_20250530_aligned.tif"


echo "Running map tile creation for: frantom_b89_rgb_20250530"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89/20250530"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89/20250530"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89/20250530" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89/20250530")
