#!/bin/bash
#SBATCH -J "maptile_frantom_b89east_rgb_20250611"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-frantom_b89east_rgb_20250611-maptiles.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-frantom_b89east_rgb_20250611-maptiles.err
#SBATCH --mem=32GB
...
job_name="frantom_b89east_rgb_20250611"

OM_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/"
OM_FILENAME="frantom_b89east_rgb_20250611_aligned.tif"


echo "Running map tile creation for: frantom_b89east_rgb_20250611"
...
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89east/20250611"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89east/20250611" | awk '{print $1}')
...
maptiles_dir=/fs/ess/PAS2699/nitrogen/data/uas/published/frantom_private/2025/frantom_b89east/20250611
