#!/bin/bash
#SBATCH -J "maptile_fsr_greenlightning_rgb_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="fsr_greenlightning_rgb_20250604_aligned.tif"


echo "Running map tile creation for: fsr_greenlightning_rgb_20250604"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/fsr_greenlightning/20250604"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/fsr_greenlightning/20250604"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/fsr_greenlightning/20250604" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/fsr_greenlightning/20250604")
