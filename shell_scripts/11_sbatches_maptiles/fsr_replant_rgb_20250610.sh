#!/bin/bash
#SBATCH -J "maptile_fsr_replant_rgb_20250610"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-fsr_replant_rgb_20250610-maptiles.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-fsr_replant_rgb_20250610-maptiles.err
#SBATCH --mem=32GB
...
OM_FILENAME="fsr_replant_rgb_20250610_aligned.tif"


echo "Running map tile creation for: fsr_replant_rgb_20250610"
...
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/fsr_replant/20250610"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/fsr_replant/20250610" | awk '{print $1}')
...
maptiles_dir=/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/fsr_replant/20250610
