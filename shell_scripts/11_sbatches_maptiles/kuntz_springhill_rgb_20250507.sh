#!/bin/bash
#SBATCH -J "maptile_kuntz_springhill_rgb_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="kuntz_springhill_rgb_20250507_aligned.tif"


echo "Running map tile creation for: kuntz_springhill_rgb_20250507"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250507"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250507"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250507" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250507")
