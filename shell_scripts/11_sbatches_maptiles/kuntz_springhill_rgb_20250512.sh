#!/bin/bash
#SBATCH -J "maptile_kuntz_springhill_rgb_20250512"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="kuntz_springhill_rgb_20250512_aligned.tif"


echo "Running map tile creation for: kuntz_springhill_rgb_20250512"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250512" | awk '{print $1}')
