#!/bin/bash
#SBATCH -J "maptile_kuntz_springhill_rgb_20250526"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-kuntz_springhill_rgb_20250526-maptiles.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-kuntz_springhill_rgb_20250526-maptiles.err
#SBATCH --mem=32GB
...
OM_FILENAME="kuntz_springhill_rgb_20250526_aligned.tif"


echo "Running map tile creation for: kuntz_springhill_rgb_20250526"
...
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250526"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250526" | awk '{print $1}')
...
maptiles_dir=/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250526
