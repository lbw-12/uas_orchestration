#!/bin/bash
#SBATCH -J "maptile_kuntz_springhill_rgb_20250602"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-kuntz_springhill_rgb_20250602-maptiles.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-kuntz_springhill_rgb_20250602-maptiles.err
#SBATCH --mem=32GB
...
job_name="kuntz_springhill_rgb_20250602"

OM_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/"
OM_FILENAME="kuntz_springhill_rgb_20250602_aligned.tif"


echo "Running map tile creation for: kuntz_springhill_rgb_20250602"
...
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250602"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250602" | awk '{print $1}')
...
maptiles_dir=/fs/ess/PAS2699/nitrogen/data/uas/published/kuntz_private/2025/kuntz_springhill/20250602
