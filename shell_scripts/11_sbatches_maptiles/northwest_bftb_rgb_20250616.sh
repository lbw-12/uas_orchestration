#!/bin/bash
#SBATCH -J "maptile_northwest_bftb_rgb_20250616"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-northwest_bftb_rgb_20250616-maptiles.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_maptiles/%j-northwest_bftb_rgb_20250616-maptiles.err
#SBATCH --mem=32GB
...
job_name="northwest_bftb_rgb_20250616"

OM_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/"
OM_FILENAME="northwest_bftb_rgb_20250616_aligned.tif"


echo "Running map tile creation for: northwest_bftb_rgb_20250616"
...
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/northwest_bftb/20250616"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/northwest_bftb/20250616" | awk '{print $1}')
...
maptiles_dir=/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/northwest_bftb/20250616
