#!/bin/bash
#SBATCH -J "maptile_northwest_n_rgb_20250512"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="northwest_n_rgb_20250512_aligned.tif"


echo "Running map tile creation for: northwest_n_rgb_20250512"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/northwest_n/20250512"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/northwest_n/20250512"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/northwest_n/20250512" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/northwest_n/20250512")
