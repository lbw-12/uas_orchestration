#!/bin/bash
#SBATCH -J "maptile_western_ncc_rgb_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="western_ncc_rgb_20250507_aligned.tif"


echo "Running map tile creation for: western_ncc_rgb_20250507"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_ncc/20250507"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_ncc/20250507"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_ncc/20250507" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_ncc/20250507")
