#!/bin/bash
#SBATCH -J "maptile_western_ncc_rgb_20250602"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="western_ncc_rgb_20250602_aligned.tif"


echo "Running map tile creation for: western_ncc_rgb_20250602"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_ncc/20250602"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_ncc/20250602"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_ncc/20250602" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_ncc/20250602")
