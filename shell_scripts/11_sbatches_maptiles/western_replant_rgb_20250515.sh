#!/bin/bash
#SBATCH -J "maptile_western_replant_rgb_20250515"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="western_replant_rgb_20250515_aligned.tif"


echo "Running map tile creation for: western_replant_rgb_20250515"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_replant/20250515"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_replant/20250515"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_replant/20250515" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/western_replant/20250515")
