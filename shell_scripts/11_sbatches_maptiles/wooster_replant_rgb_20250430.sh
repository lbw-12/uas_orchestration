#!/bin/bash
#SBATCH -J "maptile_wooster_replant_rgb_20250430"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OM_FILENAME="wooster_replant_rgb_20250430_aligned.tif"


echo "Running map tile creation for: wooster_replant_rgb_20250430"
...
mkdir -p "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/wooster_replant/20250430"
OUTPUT_DIRECTORY="/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/wooster_replant/20250430"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/wooster_replant/20250430" | awk '{print $1}')
...
maptiles_base_dir=$(dirname "/fs/ess/PAS2699/nitrogen/data/uas/published/osu_public/2025/wooster_replant/20250430")
