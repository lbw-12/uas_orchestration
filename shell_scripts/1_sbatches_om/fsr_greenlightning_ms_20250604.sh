...
#SBATCH -N 1
#SBATCH -A PAS2699
#SBATCH -J "om_fsr_greenlightning_ms_20250604"
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_om/%j-fsr_greenlightning_ms_20250604-om.txt"
...
img_dir="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250604-FSR/20250604_FSR_Replant_Altum233 Flight 01/01_Images/20250604_FSR_Replant_Altum233 Flight 01/OUTPUT/"
processing_subdir="/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/fsr_greenlightning_ms_20250604_$SLURM_JOB_ID"
...
om="fsr_greenlightning"
sensor_type="ms"
date="20250604"

om_filename="fsr_greenlightning_ms_20250604.tif"
