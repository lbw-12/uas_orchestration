...
#SBATCH -N 1
#SBATCH -A PAS2699
#SBATCH -J "om_fsr_replant_ms_20250604"
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_om/%j-fsr_replant_ms_20250604-om.txt"
...
processing_subdir="/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/fsr_replant_ms_20250604_$SLURM_JOB_ID"
...
om_filename="fsr_replant_ms_20250604.tif"
