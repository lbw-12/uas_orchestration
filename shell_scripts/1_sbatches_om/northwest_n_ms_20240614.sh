...
#SBATCH -N 1
#SBATCH -A PAS2699
#SBATCH -J "om_northwest_n_ms_20240614"
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2024/processing/logs_om/%j-northwest_n_ms_20240614-om.txt"
...
job_name="northwest_n_ms_20240614"
img_dir="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240614-Northwest/20240614_Northwest_Altum233_flight2 Flight 01/01_Images/20240614_Northwest_Altum233_flight2 Flight 01/OUTPUT_northwest_n/"
processing_subdir="/fs/ess/PAS2699/nitrogen/data/uas/2024/processing/northwest_n_ms_20240614_$SLURM_JOB_ID"
...
om_filename="northwest_n_ms_20240614.tif"
