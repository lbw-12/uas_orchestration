...
#SBATCH -N 1
#SBATCH -A PAS2699
#SBATCH -J "om_wooster_n_rgb_20240903"
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2024/processing/logs_om/%j-wooster_n_rgb_20240903-om.txt"
...
job_name="wooster_n_rgb_20240903"
img_dir="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240903-Wooster/20240903_Wooster_N_Sony150 Flight 01/01_Images/20240903_Wooster_N_Sony150 Flight 01/OUTPUT/"
processing_subdir="/fs/ess/PAS2699/nitrogen/data/uas/2024/processing/wooster_n_rgb_20240903_$SLURM_JOB_ID"
...
om_filename="wooster_n_rgb_20240903.tif"
