...
#SBATCH -N 1
#SBATCH -A PAS2699
#SBATCH -J "om_wooster_replant_rgb_20250529"
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_om/%j-wooster_replant_rgb_20250529-om.txt"
...
img_dir="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250529-Wooster/20250529_Wooster_Replant_Sony150 Flight 01/01_Images/20250529_Wooster_Replant_Sony150 Flight 01/OUTPUT/"
processing_subdir="/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/wooster_replant_rgb_20250529_$SLURM_JOB_ID"
...
om_filename="wooster_replant_rgb_20250529.tif"
