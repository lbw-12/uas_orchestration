#!/bin/bash
#SBATCH -J "omalign_douglass_jeremiah_ms_20250603"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="douglass_jeremiah_ms_20250603.tif"
PATTERN="douglass_jeremiah_ms"
...
echo "running script for omalign_douglass_jeremiah_ms_20250603"
