#!/bin/bash
#SBATCH -J "omalign_douglass_jeremiah_rgb_20250603"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="douglass_jeremiah_rgb_20250603.tif"
PATTERN="douglass_jeremiah_rgb"
...
echo "running script for omalign_douglass_jeremiah_rgb_20250603"
...
alignment_points=$(python -u ../utils/get_alignment_points.py "${SHAPEFILE_PATH}/douglass_jeremiah_pts/douglass_jeremiah_pts.shp")
