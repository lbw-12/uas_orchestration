#!/bin/bash
#SBATCH -J "omalign_frantom_b89_ms_20250530"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="frantom_b89_ms_20250530.tif"
PATTERN="frantom_b89_ms"
...
echo "running script for omalign_frantom_b89_ms_20250530"
