#!/bin/bash
#SBATCH -J "omalign_frantom_b89_rgb_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="frantom_b89_rgb_20250604.tif"
PATTERN="frantom_b89_rgb"
...
echo "running script for omalign_frantom_b89_rgb_20250604"
...
alignment_points=$(python -u ../utils/get_alignment_points.py "${SHAPEFILE_PATH}/frantom_b89_pts/frantom_b89_pts.shp")
