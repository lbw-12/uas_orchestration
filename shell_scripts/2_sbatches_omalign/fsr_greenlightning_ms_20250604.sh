#!/bin/bash
#SBATCH -J "omalign_fsr_greenlightning_ms_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="fsr_greenlightning_ms_20250604.tif"
PATTERN="fsr_greenlightning_ms"
...
echo "running script for omalign_fsr_greenlightning_ms_20250604"
