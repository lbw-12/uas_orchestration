#!/bin/bash
#SBATCH -J "omalign_fsr_nsc_rgb_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="fsr_nsc_rgb_20250604.tif"
PATTERN="fsr_nsc_rgb"
...
echo "running script for omalign_fsr_nsc_rgb_20250604"
...
alignment_points=$(python -u ../utils/get_alignment_points.py "${SHAPEFILE_PATH}/fsr_nsc_pts/fsr_nsc_pts.shp")
