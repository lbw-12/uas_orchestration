#!/bin/bash
#SBATCH -J "omalign_fsr_replant_ms_20250610"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
#SBATCH --mem=0 # This gets the full memory of the node and stores it in SLURM_MEM_PER_NODE#SBATCH --nodes=1
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_omalign/%j-fsr_replant_ms_20250610-omalign.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_omalign/%j-fsr_replant_ms_20250610-omalign.txt
#SBATCH --time=0:30:00
...
SEARCH="fsr_replant_ms_20250610.tif"
PATTERN="fsr_replant_ms"
...
echo "running script for omalign_fsr_replant_ms_20250610"
