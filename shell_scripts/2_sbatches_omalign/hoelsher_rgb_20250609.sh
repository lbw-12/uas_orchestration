#!/bin/bash
#SBATCH -J "omalign_hoelsher_rgb_20250609"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
#SBATCH --mem=0 # This gets the full memory of the node and stores it in SLURM_MEM_PER_NODE#SBATCH --nodes=1
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_omalign/%j-hoelsher_rgb_20250609-omalign.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_omalign/%j-hoelsher_rgb_20250609-omalign.txt
#SBATCH --time=0:30:00
...
SEARCH="hoelsher_rgb_20250609.tif"
PATTERN="hoelsher_rgb"
...
echo "running script for omalign_hoelsher_rgb_20250609"
...
alignment_points=$(python -u ../utils/get_alignment_points.py "${SHAPEFILE_PATH}/hoelsher_pts/hoelsher_pts.shp")
