#!/bin/bash
#SBATCH -J "omalign_kuntz_springhill_ms_20250526"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="kuntz_springhill_ms_20250526.tif"
PATTERN="kuntz_springhill_ms"
...
echo "running script for omalign_kuntz_springhill_ms_20250526"
