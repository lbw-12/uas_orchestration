#!/bin/bash
#SBATCH -J "omalign_northwest_replant_rgb_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="northwest_replant_rgb_20250507.tif"
...
echo "running script for omalign_northwest_replant_rgb_20250507"
