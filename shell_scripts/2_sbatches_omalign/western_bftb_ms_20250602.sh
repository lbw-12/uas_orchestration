#!/bin/bash
#SBATCH -J "omalign_western_bftb_ms_20250602"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="western_bftb_ms_20250602.tif"
PATTERN="western_bftb_ms"
...
echo "running script for omalign_western_bftb_ms_20250602"
