#!/bin/bash
#SBATCH -J "omalign_western_bftb_rgb_20250515"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="western_bftb_rgb_20250515.tif"
PATTERN="western_bftb_rgb"
...
echo "running script for omalign_western_bftb_rgb_20250515"
...
alignment_points=$(python -u ../utils/get_alignment_points.py "${SHAPEFILE_PATH}/western_bftb_pts/western_bftb_pts.shp")
