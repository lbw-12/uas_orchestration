#!/bin/bash
#SBATCH -J "omalign_western_ncc_rgb_20250526"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="western_ncc_rgb_20250526.tif"
PATTERN="western_ncc_rgb"
...
echo "running script for omalign_western_ncc_rgb_20250526"
