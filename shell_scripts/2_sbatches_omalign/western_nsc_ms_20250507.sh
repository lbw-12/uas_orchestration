#!/bin/bash
#SBATCH -J "omalign_western_nsc_ms_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="western_nsc_ms_20250507.tif"
PATTERN="western_nsc_ms"
...
echo "running script for omalign_western_nsc_ms_20250507"
