#!/bin/bash
#SBATCH -J "omalign_western_nsc_rgb_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="western_nsc_rgb_20250507.tif"
PATTERN="western_nsc_rgb"
...
echo "running script for omalign_western_nsc_rgb_20250507"
...
alignment_points=$(python -u ../utils/get_alignment_points.py "${SHAPEFILE_PATH}/western_nsc_pts/western_nsc_pts.shp")
