#!/bin/bash
#SBATCH -J "omalign_western_replant_ms_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="western_replant_ms_20250507.tif"
PATTERN="western_replant_ms"
...
echo "running script for omalign_western_replant_ms_20250507"
