#!/bin/bash
#SBATCH -J "omalign_western_replant_rgb_20250515"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="western_replant_rgb_20250515.tif"
PATTERN="western_replant_rgb"
...
echo "running script for omalign_western_replant_rgb_20250515"
...
alignment_points=$(python -u ../utils/get_alignment_points.py "${SHAPEFILE_PATH}/western_replant_pts/western_replant_pts.shp")
