#!/bin/bash
#SBATCH -J "omalign_wooster_bftb_rgb_20250529"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="wooster_bftb_rgb_20250529.tif"
PATTERN="wooster_bftb_rgb"
...
echo "running script for omalign_wooster_bftb_rgb_20250529"
