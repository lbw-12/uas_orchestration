#!/bin/bash
#SBATCH -J "omalign_wooster_replant_rgb_20250529"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEARCH="wooster_replant_rgb_20250529.tif"
PATTERN="wooster_replant_rgb"
...
echo "running script for omalign_wooster_replant_rgb_20250529"
