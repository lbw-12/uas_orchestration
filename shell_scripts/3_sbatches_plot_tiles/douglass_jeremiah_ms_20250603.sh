#!/bin/bash
#SBATCH -J "plottile_douglass_jeremiah_ms_20250603"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: douglass_jeremiah_ms_20250603"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="douglass_jeremiah_ms_20250603"

start_time=$(date +%s)

python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/douglass_jeremiah_ms_20250603_aligned.tif" \
    --shapefile_path_soy "" \
    --shapefile_path_corn "" \
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/douglass_jeremiah_ms_20250603/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/douglass_jeremiah_ms_20250603/" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/douglass_jeremiah_ms_20250603/" | awk '{print $1}')
