#!/bin/bash
#SBATCH -J "plottile_fsr_greenlightning_ms_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: fsr_greenlightning_ms_20250604"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="fsr_greenlightning_ms_20250604"

start_time=$(date +%s)

python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/fsr_greenlightning_ms_20250604_aligned.tif" \
    --shapefile_path_soy "" \
    --shapefile_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/shapefiles/plots/fsr_greenlightning/fsr_greenlightning.shp" \
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/fsr_greenlightning_ms_20250604/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/fsr_greenlightning_ms_20250604/" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/fsr_greenlightning_ms_20250604/" | awk '{print $1}')
