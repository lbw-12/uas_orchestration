#!/bin/bash
#SBATCH -J "plottile_fsr_nsc_rgb_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: fsr_nsc_rgb_20250604"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="fsr_nsc_rgb_20250604"

start_time=$(date +%s)

python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/fsr_nsc_rgb_20250604_aligned.tif" \
    --shapefile_path_soy "" \
    --shapefile_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/shapefiles/plots/fsr_n_cc/fsr_n_cc.shp" \
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/fsr_nsc_rgb_20250604/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/fsr_nsc_rgb_20250604/" \
    --location "fsr_nsc" \
    --date "20250604" \
    --plotimage_source "om"
...
plot_area_corn_m2=$(python -u ../utils/get_plot_area.py "/fs/ess/PAS2699/nitrogen/data/uas/2025/shapefiles/plots/fsr_n_cc/fsr_n_cc.shp")
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/fsr_nsc_rgb_20250604/" | awk '{print $1}')
