#!/bin/bash
#SBATCH -J "plottile_hoelsher_ms_20250530"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: hoelsher_ms_20250530"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="hoelsher_ms_20250530"

start_time=$(date +%s)

python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/hoelsher_ms_20250530_aligned.tif" \
    --shapefile_path_soy "" \
    --shapefile_path_corn "" \
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/hoelsher_ms_20250530/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/hoelsher_ms_20250530/" \
    --location "hoelsher" \
    --date "20250530" \
    --plotimage_source "om"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/hoelsher_ms_20250530/" | awk '{print $1}')
