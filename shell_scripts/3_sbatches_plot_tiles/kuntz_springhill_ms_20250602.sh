#!/bin/bash
#SBATCH -J "plottile_kuntz_springhill_ms_20250602"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: kuntz_springhill_ms_20250602"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="kuntz_springhill_ms_20250602"

start_time=$(date +%s)

python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/kuntz_springhill_ms_20250602_aligned.tif" \
    --shapefile_path_soy "" \
    --shapefile_path_corn "" \
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/kuntz_springhill_ms_20250602/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/kuntz_springhill_ms_20250602/" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/kuntz_springhill_ms_20250602/" | awk '{print $1}')
