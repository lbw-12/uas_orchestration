#!/bin/bash
#SBATCH -J "plottile_northwest_bftb_ms_20250609"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: northwest_bftb_ms_20250609"
...
python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/northwest_bftb_ms_20250609_aligned.tif" \
    ...
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/northwest_bftb_ms_20250609/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/northwest_bftb_ms_20250609/" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/northwest_bftb_ms_20250609/" | awk '{print $1}')
