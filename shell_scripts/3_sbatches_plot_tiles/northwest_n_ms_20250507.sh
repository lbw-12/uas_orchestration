#!/bin/bash
#SBATCH -J "plottile_northwest_n_ms_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: northwest_n_ms_20250507"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="northwest_n_ms_20250507"

start_time=$(date +%s)

python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/northwest_n_ms_20250507_aligned.tif" \
    --shapefile_path_soy "" \
    --shapefile_path_corn "" \
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/northwest_n_ms_20250507/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/northwest_n_ms_20250507/" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/northwest_n_ms_20250507/" | awk '{print $1}')
