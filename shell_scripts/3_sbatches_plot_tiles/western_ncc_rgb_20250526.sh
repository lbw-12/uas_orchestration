#!/bin/bash
#SBATCH -J "plottile_western_ncc_rgb_20250526"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: western_ncc_rgb_20250526"
...
python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/western_ncc_rgb_20250526_aligned.tif" \
    --shapefile_path_soy "" \
    --shapefile_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/shapefiles/plots/western_n_cc/western_n_cc.shp" \
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/western_ncc_rgb_20250526/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/western_ncc_rgb_20250526/" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/western_ncc_rgb_20250526/" | awk '{print $1}')
