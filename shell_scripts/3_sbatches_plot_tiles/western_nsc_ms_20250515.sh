#!/bin/bash
#SBATCH -J "plottile_western_nsc_ms_20250515"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: western_nsc_ms_20250515"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="western_nsc_ms_20250515"

start_time=$(date +%s)

python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/western_nsc_ms_20250515_aligned.tif" \
    --shapefile_path_soy "" \
    --shapefile_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/shapefiles/plots/western_n_sc/western_n_sc.shp" \
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/western_nsc_ms_20250515/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/western_nsc_ms_20250515/" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/western_nsc_ms_20250515/" | awk '{print $1}')
