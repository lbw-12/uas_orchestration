#!/bin/bash
#SBATCH -J "plottile_wooster_bftb_rgb_20250603"
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Running plot tile extraction for: wooster_bftb_rgb_20250603"
...
python "plot_tiles_ir_om.py" \
    --csv_file_path "" \
    --image_folder_path "/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/wooster_bftb_rgb_20250603_aligned.tif" \
    ...
    --output_path_soy "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/wooster_bftb_rgb_20250603/" \
    --output_path_corn "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/wooster_bftb_rgb_20250603/" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/wooster_bftb_rgb_20250603/" | awk '{print $1}')
