#!/bin/bash
#SBATCH -J "dgr_farmscience_rgb_20240528"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240528-FarmScience/20240528_F7Ntrials_Sony172 Flight 02/01_Images/20240528_F7Ntrials_Sony172 Flight 02/OUTPUT/"
