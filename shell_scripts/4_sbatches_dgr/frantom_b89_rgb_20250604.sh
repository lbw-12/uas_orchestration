#!/bin/bash
#SBATCH -J "dgr_frantom_b89_rgb_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250604-Frantom/20250604_Frantom_Sony150 Flight 01/01_Images/20250604_Frantom_Sony150 Flight 01/OUTPUT/"
