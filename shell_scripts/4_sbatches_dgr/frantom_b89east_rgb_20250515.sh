#!/bin/bash
#SBATCH -J "dgr_frantom_b89east_rgb_20250515"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250515-Frantom/20250515_Frantom_Sony150 Flight 01/01_Images/20250515_Frantom_Sony150 Flight 01/OUTPUT_frantom_b89east/"
