#!/bin/bash
#SBATCH -J "dgr_frantom_rgb_20240621"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240621-Frantom/20240621_Frantom_B123_Sony172 Flight 01/01_Images/20240621_Frantom_B123_Sony172 Flight 01/OUTPUT_frantom/"
