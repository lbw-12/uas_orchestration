#!/bin/bash
#SBATCH -J "dgr_frantom_rgb_20240723"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240723-Frantom/20240723_Frantom_B123_Sony172_2 Flight 01/01_Images/20240723_Frantom_B123_Sony172_2 Flight 01/OUTPUT_frantom/"
