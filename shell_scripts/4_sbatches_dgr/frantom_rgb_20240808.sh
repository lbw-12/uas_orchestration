#!/bin/bash
#SBATCH -J "dgr_frantom_rgb_20240808"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240808-Frantom/20240808_Frantom_B123_Sony172 Flight 01/01_Images/20240808_Frantom_B123_Sony172 Flight 01/OUTPUT_frantom/"
