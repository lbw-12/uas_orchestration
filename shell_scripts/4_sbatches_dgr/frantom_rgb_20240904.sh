#!/bin/bash
#SBATCH -J "dgr_frantom_rgb_20240904"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240904-Frantom/20240904_Frantom_B123_Sony172 Flight 01/01_Images/20240904_Frantom_B123_Sony172 Flight 01/OUTPUT_frantom/"
