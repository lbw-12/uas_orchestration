#!/bin/bash
#SBATCH -J "dgr_fsr_nitrogen_rgb_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
#SBATCH --mem=0 # This gets the full memory of the node and stores it in SLURM_MEM_PER_NODE
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_dgr/%j-fsr_nitrogen_rgb_20250604-dgr.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_dgr/%j-fsr_nitrogen_rgb_20250604-dgr.err
#SBATCH --time=0:30:00
