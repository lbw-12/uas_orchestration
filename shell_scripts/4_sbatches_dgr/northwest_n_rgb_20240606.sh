#!/bin/bash
#SBATCH -J "dgr_northwest_n_rgb_20240606"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240606-Northwest/20240606_Northwest_Sony150 Flight 01/01_Images/20240606_Northwest_Sony150 Flight 01/OUTPUT_northwest_n/"
