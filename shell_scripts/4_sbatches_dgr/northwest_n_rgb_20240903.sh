#!/bin/bash
#SBATCH -J "dgr_northwest_n_rgb_20240903"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240903-Northwest/20240903_Northwest_Sony150 Flight 01/01_Images/20240903_Northwest_Sony150 Flight 01/OUTPUT_northwest_n/"
