#!/bin/bash
#SBATCH -J "dgr_northwest_n_rgb_20250602"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250602-Northwest/20250602_Northwest_sony150 Flight 01/01_Images/20250602_Northwest_sony150 Flight 01/OUTPUT_northwest_n/"
