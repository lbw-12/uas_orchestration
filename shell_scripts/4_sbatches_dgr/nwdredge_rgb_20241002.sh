#!/bin/bash
#SBATCH -J "dgr_nwdredge_rgb_20241002"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20241002-NWDredge/20240903_Northwest_Sony150_copy Flight 01/01_Images/20240903_Northwest_Sony150_copy Flight 01/OUTPUT/"
