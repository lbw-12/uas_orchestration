#!/bin/bash
#SBATCH -J "dgr_western_bftb_rgb_20240621"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240621-Western/20240621_Western_BFTB_Sony150 Flight 01/01_Images/20240621_Western_BFTB_Sony150 Flight 01/OUTPUT/"
