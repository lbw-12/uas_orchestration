#!/bin/bash
#SBATCH -J "dgr_western_n_rgb_20240516"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240516-Western/20240516_Western_N_Sony_150 Flight 01/01_Images/20240516_Western_N_Sony_150 Flight 01/OUTPUT/"
