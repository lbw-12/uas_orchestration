#!/bin/bash
#SBATCH -J "dgr_western_replant_rgb_20250526"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250526-Western/20250526_Western_Sony150 Flight 01/01_Images/20250526_Western_Sony150 Flight 01/OUTPUT_western_replant/"
