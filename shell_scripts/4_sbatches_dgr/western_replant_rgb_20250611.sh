#!/bin/bash
#SBATCH -J "dgr_western_replant_rgb_20250611"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250611-Western/20250611_Western_Sony150_copy Flight 01/01_Images/20250611_Western_Sony150_copy Flight 01/OUTPUT_western_replant/"
