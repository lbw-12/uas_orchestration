#!/bin/bash
#SBATCH -J "dgr_wooster_bftb_rgb_20240609"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240609-Wooster/20240609_Wooster_BFTB_Sony150 Flight 01/01_Images/20240609_Wooster_BFTB_Sony150 Flight 01/OUTPUT/"
