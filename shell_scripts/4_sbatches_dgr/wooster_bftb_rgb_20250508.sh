#!/bin/bash
#SBATCH -J "dgr_wooster_bftb_rgb_20250508"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250508-Wooster/20250508_Wooster_BFTB_Sony150 Flight 01/01_Images/20250508_Wooster_BFTB_Sony150 Flight 01/OUTPUT/"
