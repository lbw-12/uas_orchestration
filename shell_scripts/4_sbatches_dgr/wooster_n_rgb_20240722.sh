#!/bin/bash
#SBATCH -J "dgr_wooster_n_rgb_20240722"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2024/flights/20240722-Wooster/20240722_Wooster_N_Sony150 Flight 01/01_Images/20240722_Wooster_N_Sony150 Flight 01/OUTPUT/"
