#!/bin/bash
#SBATCH -J "dgr_wooster_replant_rgb_20250529"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
#SBATCH --mem=0 # This gets the full memory of the node and stores it in SLURM_MEM_PER_NODE
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_dgr/%j-wooster_replant_rgb_20250529-dgr.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_dgr/%j-wooster_replant_rgb_20250529-dgr.err
#SBATCH --time=0:30:00

source /fs/ess/PAS2699/envs/miniconda3/etc/profile.d/conda.sh
conda activate harvest

FLIGHT_DIR="/fs/ess/PAS2699/nitrogen/data/uas/2025/flights/20250529-Wooster/20250529_Wooster_Replant_Sony150 Flight 01/01_Images/20250529_Wooster_Replant_Sony150 Flight 01/OUTPUT/"
