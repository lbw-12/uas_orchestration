#!/bin/bash
#SBATCH -J "ir_farmscience_rgb_20240621"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/farmscience_rgb_20240621/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/farmscience_rgb_20240621/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/farmscience_rgb_20240621_aligned.tif"
...
echo "Img Reg job done for 20240621-farmscience_rgb_20240621, total time of execution: $execution_time seconds"
