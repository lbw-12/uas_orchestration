#!/bin/bash
#SBATCH -J "ir_farmscience_rgb_20240711"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/farmscience_rgb_20240711/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/farmscience_rgb_20240711/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/farmscience_rgb_20240711_aligned.tif"
...
echo "Img Reg job done for 20240711-farmscience_rgb_20240711, total time of execution: $execution_time seconds"
