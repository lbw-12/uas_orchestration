#!/bin/bash
#SBATCH -J "ir_frantom_b89west_rgb_20250611"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2025/dgr/frantom_b89west_rgb_20250611/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2025/ir/frantom_b89west_rgb_20250611/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/frantom_b89west_rgb_20250611_aligned.tif"
...
echo "Img Reg job done for 20250611-frantom_b89west_rgb_20250611, total time of execution: $execution_time seconds"
