#!/bin/bash
#SBATCH -J "ir_frantom_rgb_20240802"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/frantom_rgb_20240802/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/frantom_rgb_20240802/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/frantom_rgb_20240802_aligned.tif"
...
echo "Img Reg job done for 20240802-frantom_rgb_20240802, total time of execution: $execution_time seconds"
