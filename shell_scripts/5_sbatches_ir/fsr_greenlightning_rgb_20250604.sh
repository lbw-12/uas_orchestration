#!/bin/bash
#SBATCH -J "ir_fsr_greenlightning_rgb_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2025/dgr/fsr_greenlightning_rgb_20250604/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2025/ir/fsr_greenlightning_rgb_20250604/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/fsr_greenlightning_rgb_20250604_aligned.tif"
...
echo "Img Reg job done for 20250604-fsr_greenlightning_rgb_20250604, total time of execution: $execution_time seconds"
