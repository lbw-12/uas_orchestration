#!/bin/bash
#SBATCH -J "ir_northwest_bftb_rgb_20240606"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/northwest_bftb_rgb_20240606/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/northwest_bftb_rgb_20240606/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/northwest_bftb_rgb_20240606_aligned.tif"
...
echo "Img Reg job done for 20240606-northwest_bftb_rgb_20240606, total time of execution: $execution_time seconds"
