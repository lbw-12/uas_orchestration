#!/bin/bash
#SBATCH -J "ir_northwest_bftb_rgb_20240614"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/northwest_bftb_rgb_20240614/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/northwest_bftb_rgb_20240614/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/northwest_bftb_rgb_20240614_aligned.tif"
...
echo "Img Reg job done for 20240614-northwest_bftb_rgb_20240614, total time of execution: $execution_time seconds"
