#!/bin/bash
#SBATCH -J "ir_northwest_bftb_rgb_20250526"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2025/dgr/northwest_bftb_rgb_20250526/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2025/ir/northwest_bftb_rgb_20250526/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/northwest_bftb_rgb_20250526_aligned.tif"
...
echo "Img Reg job done for 20250526-northwest_bftb_rgb_20250526, total time of execution: $execution_time seconds"
