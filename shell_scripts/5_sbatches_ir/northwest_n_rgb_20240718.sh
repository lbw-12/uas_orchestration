#!/bin/bash
#SBATCH -J "ir_northwest_n_rgb_20240718"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/northwest_n_rgb_20240718/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/northwest_n_rgb_20240718/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/northwest_n_rgb_20240718_aligned.tif"
...
echo "Img Reg job done for 20240718-northwest_n_rgb_20240718, total time of execution: $execution_time seconds"
