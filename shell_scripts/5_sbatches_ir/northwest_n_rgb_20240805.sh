#!/bin/bash
#SBATCH -J "ir_northwest_n_rgb_20240805"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/northwest_n_rgb_20240805/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/northwest_n_rgb_20240805/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/northwest_n_rgb_20240805_aligned.tif"
...
echo "Img Reg job done for 20240805-northwest_n_rgb_20240805, total time of execution: $execution_time seconds"
