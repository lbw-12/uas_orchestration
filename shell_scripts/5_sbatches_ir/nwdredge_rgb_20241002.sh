#!/bin/bash
#SBATCH -J "ir_nwdredge_rgb_20241002"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/nwdredge_rgb_20241002/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/nwdredge_rgb_20241002/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/nwdredge_rgb_20241002_aligned.tif"
...
echo "Img Reg job done for 20241002-nwdredge_rgb_20241002, total time of execution: $execution_time seconds"
