#!/bin/bash
#SBATCH -J "ir_western_bftb_rgb_20240808"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/western_bftb_rgb_20240808/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/western_bftb_rgb_20240808/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/western_bftb_rgb_20240808_aligned.tif"
...
echo "Img Reg job done for 20240808-western_bftb_rgb_20240808, total time of execution: $execution_time seconds"
