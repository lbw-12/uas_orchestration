#!/bin/bash
#SBATCH -J "ir_western_bftb_rgb_20240904"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/western_bftb_rgb_20240904/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/western_bftb_rgb_20240904/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/western_bftb_rgb_20240904_aligned.tif"
...
echo "Img Reg job done for 20240904-western_bftb_rgb_20240904, total time of execution: $execution_time seconds"
