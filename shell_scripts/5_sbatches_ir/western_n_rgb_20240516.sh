#!/bin/bash
#SBATCH -J "ir_western_n_rgb_20240516"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/western_n_rgb_20240516/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/western_n_rgb_20240516/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/western_n_rgb_20240516_aligned.tif"
...
echo "Img Reg job done for 20240516-western_n_rgb_20240516, total time of execution: $execution_time seconds"
