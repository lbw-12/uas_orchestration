#!/bin/bash
#SBATCH -J "ir_western_ncc_rgb_20250611"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
#SBATCH --mem=0 # This gets the full memory of the node and stores it in SLURM_MEM_PER_NODE
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_ir/%j-western_ncc_rgb_20250611-ir.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_ir/%j-western_ncc_rgb_20250611-ir.err
#SBATCH --time=0:30:00
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2025/dgr/western_ncc_rgb_20250611/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2025/ir/western_ncc_rgb_20250611/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/western_ncc_rgb_20250611_aligned.tif"
...
echo "Img Reg job done for 20250611-western_ncc_rgb_20250611, total time of execution: $execution_time seconds"
