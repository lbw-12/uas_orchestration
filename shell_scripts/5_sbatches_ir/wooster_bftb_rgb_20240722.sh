#!/bin/bash
#SBATCH -J "ir_wooster_bftb_rgb_20240722"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/wooster_bftb_rgb_20240722/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/wooster_bftb_rgb_20240722/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/wooster_bftb_rgb_20240722_aligned.tif"
...
echo "Img Reg job done for 20240722-wooster_bftb_rgb_20240722, total time of execution: $execution_time seconds"
