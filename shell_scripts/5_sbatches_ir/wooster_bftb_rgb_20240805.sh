#!/bin/bash
#SBATCH -J "ir_wooster_bftb_rgb_20240805"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/wooster_bftb_rgb_20240805/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/wooster_bftb_rgb_20240805/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/wooster_bftb_rgb_20240805_aligned.tif"
...
echo "Img Reg job done for 20240805-wooster_bftb_rgb_20240805, total time of execution: $execution_time seconds"
