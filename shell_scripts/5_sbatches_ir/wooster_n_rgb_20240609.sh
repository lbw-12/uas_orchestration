#!/bin/bash
#SBATCH -J "ir_wooster_n_rgb_20240609"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
...
OUTPUT_PATH_GEO="/fs/ess/PAS2699/nitrogen/data/uas/2024/dgr/wooster_n_rgb_20240609/"  
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2024/ir/wooster_n_rgb_20240609/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2024/orthomosaics/v2_5_aligned/wooster_n_rgb_20240609_aligned.tif"
...
echo "Img Reg job done for 20240609-wooster_n_rgb_20240609, total time of execution: $execution_time seconds"
