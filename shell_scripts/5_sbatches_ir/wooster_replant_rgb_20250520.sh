#!/bin/bash
#SBATCH -J "ir_wooster_replant_rgb_20250520"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --exclusive
#SBATCH --mem=0 # This gets the full memory of the node and stores it in SLURM_MEM_PER_NODE
#SBATCH -A PAS2699
#SBATCH -o "/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_ir/%j-wooster_replant_rgb_20250520-ir.txt"
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_ir/%j-wooster_replant_rgb_20250520-ir.err
#SBATCH --time=0:30:00
...
OUTPUT_PATH_IR="/fs/ess/PAS2699/nitrogen/data/uas/2025/ir/wooster_replant_rgb_20250520/" 
ORTHO_PATH="/fs/ess/PAS2699/nitrogen/data/uas/2025/orthomosaics/aligned/wooster_replant_rgb_20250520_aligned.tif"
...
echo "Img Reg job done for 20250520-wooster_replant_rgb_20250520, total time of execution: $execution_time seconds"
