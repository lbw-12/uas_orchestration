#!/bin/bash
#SBATCH -J "plottile_to_patches_douglass_jeremiah_rgb_20250603"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_plot_to_patch/%j-douglass_jeremiah_rgb_20250603-plot_to_patch.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_plot_to_patch/%j-douglass_jeremiah_rgb_20250603-plot_to_patch.err
...
echo "Running plot tile to patches extraction for: douglass_jeremiah_rgb_20250603"
...
python "plot_tiles_to_patches.py" \
    ...
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/douglass_jeremiah_om_rgb_20250603/"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/douglass_jeremiah_om_rgb_20250603/" | awk '{print $1}')
