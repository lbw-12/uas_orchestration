...
echo "Running plot tile to patches extraction for: frantom_b89_rgb_20250604"
...
python "plot_tiles_to_patches.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/frantom_b89_rgb_20250604/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/frantom_b89_om_rgb_20250604/"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/frantom_b89_om_rgb_20250604/" | awk '{print $1}')
