#!/bin/bash
#SBATCH -J "plottile_to_patches_fsr_nitrogen_rgb_20250610"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_plot_to_patch/%j-fsr_nitrogen_rgb_20250610-plot_to_patch.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_plot_to_patch/%j-fsr_nitrogen_rgb_20250610-plot_to_patch.err
...
echo "Running plot tile to patches extraction for: fsr_nitrogen_rgb_20250610"
...
python "plot_tiles_to_patches.py" \
    ...
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/fsr_nitrogen_om_rgb_20250610/"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/fsr_nitrogen_om_rgb_20250610/" | awk '{print $1}')
