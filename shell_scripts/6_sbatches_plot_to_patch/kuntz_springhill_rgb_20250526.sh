#!/bin/bash
#SBATCH -J "plottile_to_patches_kuntz_springhill_rgb_20250526"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_plot_to_patch/%j-kuntz_springhill_rgb_20250526-plot_to_patch.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_plot_to_patch/%j-kuntz_springhill_rgb_20250526-plot_to_patch.err
