...
echo "Running plot tile to patches extraction for: northwest_n_rgb_20250602"
...
python "plot_tiles_to_patches.py" \
    ...
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/northwest_n_om_rgb_20250602/"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/northwest_n_om_rgb_20250602/" | awk '{print $1}')
