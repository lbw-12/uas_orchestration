...
echo "Running plot tile to patches extraction for: western_bftb_rgb_20250519"
...
python "plot_tiles_to_patches.py" \
    ...
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/western_bftb_om_rgb_20250519/"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/western_bftb_om_rgb_20250519/" | awk '{print $1}')
