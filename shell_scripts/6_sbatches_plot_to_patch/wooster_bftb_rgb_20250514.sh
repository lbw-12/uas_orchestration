...
echo "Running plot tile to patches extraction for: wooster_bftb_rgb_20250514"
...
python "plot_tiles_to_patches.py" \
    ...
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/wooster_bftb_om_rgb_20250514/"
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/wooster_bftb_om_rgb_20250514/" | awk '{print $1}')
