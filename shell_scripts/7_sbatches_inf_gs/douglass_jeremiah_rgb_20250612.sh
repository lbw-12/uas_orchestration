#!/bin/bash
#SBATCH -J "gs_douglass_jeremiah_rgb_20250612"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-douglass_jeremiah_rgb_20250612-inf_gs.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-douglass_jeremiah_rgb_20250612-inf_gs.err
...
echo "Running growth stage inference for: douglass_jeremiah_rgb_20250612"
...
python "inference_growth_stage.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/douglass_jeremiah_om_rgb_20250612/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_douglass_jeremiah_om_20250612.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_douglass_jeremiah_om_20250612.json" | awk '{print $1}')
