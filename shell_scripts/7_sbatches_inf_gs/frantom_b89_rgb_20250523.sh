...
echo "Running growth stage inference for: frantom_b89_rgb_20250523"
...
python "inference_growth_stage.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/frantom_b89_om_rgb_20250523/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inference_frantom_b89_rgb_20250523_gs.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inference_frantom_b89_rgb_20250523_gs.json" | awk '{print $1}')
