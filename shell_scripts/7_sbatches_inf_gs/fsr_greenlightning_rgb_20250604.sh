...
echo "Running growth stage inference for: fsr_greenlightning_rgb_20250604"
...
python "inference_growth_stage.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/fsr_greenlightning_om_rgb_20250604/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inference_fsr_greenlightning_rgb_20250604_gs.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inference_fsr_greenlightning_rgb_20250604_gs.json" | awk '{print $1}')
