#!/bin/bash
#SBATCH -J "gs_fsr_replant_rgb_20250610"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-fsr_replant_rgb_20250610-inf_gs.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-fsr_replant_rgb_20250610-inf_gs.err
...
echo "Running growth stage inference for: fsr_replant_rgb_20250610"
...
python "inference_growth_stage.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/fsr_replant_om_rgb_20250610/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_fsr_replant_om_20250610.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_fsr_replant_om_20250610.json" | awk '{print $1}')
