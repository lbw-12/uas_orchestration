#!/bin/bash
#SBATCH -J "gs_kuntz_springhill_rgb_20250526"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-kuntz_springhill_rgb_20250526-inf_gs.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-kuntz_springhill_rgb_20250526-inf_gs.err
...
echo "Running growth stage inference for: kuntz_springhill_rgb_20250526"
...
python "inference_growth_stage.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/kuntz_springhill_om_rgb_20250526/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_kuntz_springhill_om_20250526.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_kuntz_springhill_om_20250526.json" | awk '{print $1}')
