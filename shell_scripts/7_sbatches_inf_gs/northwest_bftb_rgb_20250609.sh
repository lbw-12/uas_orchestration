#!/bin/bash
#SBATCH -J "gs_northwest_bftb_rgb_20250609"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-northwest_bftb_rgb_20250609-inf_gs.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-northwest_bftb_rgb_20250609-inf_gs.err
...
echo "Running growth stage inference for: northwest_bftb_rgb_20250609"
...
python "inference_growth_stage.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/northwest_bftb_om_rgb_20250609/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_northwest_bftb_om_20250609.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_northwest_bftb_om_20250609.json" | awk '{print $1}')
