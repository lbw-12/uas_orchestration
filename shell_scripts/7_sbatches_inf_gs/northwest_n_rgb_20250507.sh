#!/bin/bash
#SBATCH -J "gs_northwest_n_rgb_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-northwest_n_rgb_20250507-inf_gs.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-northwest_n_rgb_20250507-inf_gs.err
...
echo "Running growth stage inference for: northwest_n_rgb_20250507"
...
python "inference_growth_stage.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/northwest_n_om_rgb_20250507/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_northwest_n_om_20250507.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_northwest_n_om_20250507.json" | awk '{print $1}')
