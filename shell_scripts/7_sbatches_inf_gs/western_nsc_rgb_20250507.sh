...
python "inference_growth_stage.py" \
    ...
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inference_western_nsc_rgb_20250507_gs.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inference_western_nsc_rgb_20250507_gs.json" | awk '{print $1}')
