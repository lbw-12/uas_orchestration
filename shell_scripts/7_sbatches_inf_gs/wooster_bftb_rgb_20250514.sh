#!/bin/bash
#SBATCH -J "gs_wooster_bftb_rgb_20250514"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-wooster_bftb_rgb_20250514-inf_gs.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_gs/%j-wooster_bftb_rgb_20250514-inf_gs.err
...
echo "Running growth stage inference for: wooster_bftb_rgb_20250514"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="wooster_bftb_rgb_20250514"

start_time=$(date +%s)

python "inference_growth_stage.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plot_patches/wooster_bftb_om_rgb_20250514/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_wooster_bftb_om_20250514.json" \
...
output_size=$(du -sh "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_gs_wooster_bftb_om_20250514.json" | awk '{print $1}')
