#!/bin/bash
#SBATCH -J "cc_douglass_lincoln_rgb_20250603"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_cc/%j-douglass_lincoln_rgb_20250603-inf_cc.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_cc/%j-douglass_lincoln_rgb_20250603-inf_cc.err
...
echo "Running canopy coverage inference for: douglass_lincoln_rgb_20250603"
...
python "inference_canopy_cover.py" \
    ...
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_cc_douglass_lincoln_om_20250603.json" \
