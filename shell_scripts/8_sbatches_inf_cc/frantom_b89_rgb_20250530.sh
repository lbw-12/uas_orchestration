...
echo "Running canopy coverage inference for: frantom_b89_rgb_20250530"
...
python "inference_canopy_cover.py" \
    ...
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inference_frantom_b89_rgb_20250530_cc.json" \
