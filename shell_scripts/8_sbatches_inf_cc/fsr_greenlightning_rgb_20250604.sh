...
echo "Running canopy coverage inference for: fsr_greenlightning_rgb_20250604"
...
python "inference_canopy_cover.py" \
    ...
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inference_fsr_greenlightning_rgb_20250604_cc.json" \
