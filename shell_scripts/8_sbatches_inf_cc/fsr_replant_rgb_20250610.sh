#!/bin/bash
#SBATCH -J "cc_fsr_replant_rgb_20250610"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_cc/%j-fsr_replant_rgb_20250610-inf_cc.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_cc/%j-fsr_replant_rgb_20250610-inf_cc.err
...
echo "Running canopy coverage inference for: fsr_replant_rgb_20250610"
...
python "inference_canopy_cover.py" \
    ...
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_cc_fsr_replant_om_20250610.json" \
