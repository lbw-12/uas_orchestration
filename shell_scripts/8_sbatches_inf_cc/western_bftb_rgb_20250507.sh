#!/bin/bash
#SBATCH -J "cc_western_bftb_rgb_20250507"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_cc/%j-western_bftb_rgb_20250507-inf_cc.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_cc/%j-western_bftb_rgb_20250507-inf_cc.err
...
echo "Running canopy coverage inference for: western_bftb_rgb_20250507"
...
python "inference_canopy_cover.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/western_bftb_rgb_20250507/" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_cc_western_bftb_om_20250507.json" \
