#!/bin/bash
#SBATCH -J "cc_wooster_bftb_rgb_20250514"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_cc/%j-wooster_bftb_rgb_20250514-inf_cc.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_cc/%j-wooster_bftb_rgb_20250514-inf_cc.err
...
echo "Running canopy coverage inference for: wooster_bftb_rgb_20250514"
...
python "inference_canopy_cover.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_rgb_om/wooster_bftb_rgb_20250514/" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_cc_wooster_bftb_om_20250514.json" \
