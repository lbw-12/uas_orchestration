#!/bin/bash
#SBATCH -J "sr_douglass_jeremiah_ms_20250603"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_sr/%j-douglass_jeremiah_ms_20250603-inf_sr.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_sr/%j-douglass_jeremiah_ms_20250603-inf_sr.err
...
echo "Running spectral reflectance inference for: douglass_jeremiah_ms_20250603"
...
python "inference_spectral_reflectance.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/douglass_jeremiah_ms_20250603/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_sr_douglass_jeremiah_om_20250603.json" \
