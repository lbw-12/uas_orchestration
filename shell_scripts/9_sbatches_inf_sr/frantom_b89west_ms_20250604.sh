#!/bin/bash
#SBATCH -J "sr_frantom_b89west_ms_20250604"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_sr/%j-frantom_b89west_ms_20250604-inf_sr.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_sr/%j-frantom_b89west_ms_20250604-inf_sr.err
...
echo "Running spectral reflectance inference for: frantom_b89west_ms_20250604"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="frantom_b89west_ms_20250604"

start_time=$(date +%s)

python "inference_spectral_reflectance.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/frantom_b89west_ms_20250604/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_sr_frantom_b89west_om_20250604.json" \
