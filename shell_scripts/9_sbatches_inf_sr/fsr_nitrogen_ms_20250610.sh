#!/bin/bash
#SBATCH -J "sr_fsr_nitrogen_ms_20250610"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_sr/%j-fsr_nitrogen_ms_20250610-inf_sr.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_sr/%j-fsr_nitrogen_ms_20250610-inf_sr.err
...
echo "Running spectral reflectance inference for: fsr_nitrogen_ms_20250610"

num_cores=$(nproc)
echo Number of cores: $num_cores

job_name="fsr_nitrogen_ms_20250610"

start_time=$(date +%s)

python "inference_spectral_reflectance.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/fsr_nitrogen_ms_20250610/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_sr_fsr_nitrogen_om_20250610.json" \
