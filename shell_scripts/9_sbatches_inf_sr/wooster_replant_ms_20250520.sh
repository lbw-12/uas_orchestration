#!/bin/bash
#SBATCH -J "sr_wooster_replant_ms_20250520"
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_sr/%j-wooster_replant_ms_20250520-inf_sr.txt
#SBATCH --error=/fs/ess/PAS2699/nitrogen/data/uas/2025/processing/logs_inf_sr/%j-wooster_replant_ms_20250520-inf_sr.err
...
echo "Running spectral reflectance inference for: wooster_replant_ms_20250520"
...
python "inference_spectral_reflectance.py" \
    --input_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/plottiles/plot_tiles_ms_om/wooster_replant_ms_20250520/" \
    --output_dir "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/" \
    --output_json "/fs/ess/PAS2699/nitrogen/data/uas/2025/inference/inf_sr_wooster_replant_om_20250520.json" \
